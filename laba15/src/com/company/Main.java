...
public class Main {
    public static void main(String[] args) {
        Clothes[] clothes = {
                new Atelier.TShirt(ClothesSize.M, "Жёлтый", 150),
                new Atelier.TShirt(ClothesSize.S, "Коричневый", 85),
                new Atelier.Trousers(ClothesSize.XXS, "Синий", 5000),
                new Atelier.Trousers(ClothesSize.M, "Оранжевый", 6000),
                new Atelier.Skirt(ClothesSize.XS, "Серый", 1000),
                new Atelier.Skirt(ClothesSize.L, "Чёрный", 1300),
                new Atelier.Tie(ClothesSize.XS, "Фиолетовый", 2400),
                new Atelier.Tie(ClothesSize.XXS, "Зелёный", 3100),
        };
